...
public class PurchaseService {
    ...
    // 닉네임으로 구매한 상품 조회
    public List<Purchase> getPurchasesByNickname(String buyerNickname, String Authorization) throws Exception {
    ...
    // 구매 내역 삭제
    public boolean deletePurchase(Long productId, String Authorization) throws Exception {
    	boolean isAuthorized = loginDao.checkToken(Authorization);
